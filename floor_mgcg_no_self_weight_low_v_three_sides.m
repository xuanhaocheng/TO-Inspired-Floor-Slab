...
fixed14=3*nodeNrs( nely+1, 1, 1:nelx + 1)-2;
fixed15=3*nodeNrs( nely+1, 1, 1:nelx + 1)-1;
fixed16=3*nodeNrs( nely+1, 1, 1:nelx + 1);
...
filename = strcat('xphys_one_floor_lowv_three_',num2str(volfrac0),'_',num2str(loop),'.mat');
% Use the save function to save variables to a file
save(filename, 'xPhys','-v7.3');
filename1 = strcat('one_floor_U__lowv_three_',num2str(volfrac0),'_',num2str(loop),'.mat');
% Use the save function to save variables to a file
...
savefig(strcat('QNC_one_floor_lowv_three_',num2str(loop),'.fig'));
%end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
