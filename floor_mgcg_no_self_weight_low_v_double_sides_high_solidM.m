...
filename = strcat('xphys_one_floor_lowv_double_highr_solidM_',num2str(volfrac0),'_',num2str(loop),'.mat');
% Use the save function to save variables to a file
save(filename, 'xPhys','-v7.3');
filename1 = strcat('one_floor_U__lowv_double_highr_solidM_',num2str(volfrac0),'_',num2str(loop),'.mat');
% Use the save function to save variables to a file
...
savefig(strcat('QNC_V1_one_floor_U__lowv_double_highr_solidM_',num2str(loop),'.fig'));
%end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
